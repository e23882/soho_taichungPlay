...
<!-- 移動式訊息區塊 -->
	...
	<div class="row"  style="margin-top:5%;margin-bottom:15%;width:100%; position: absolute;left: 0;right: 0;margin-left: auto;margin-right: auto;">
		...
		<div class="col-xs-6 col-md-6" style="text-align:center;">
			<a href="normalrestaurant.php"><img src="images/normalrestaurant.png" style="border-radius:50%;width:60%;" alt=""/></a>
		</div>
		<div class="col-xs-6 col-md-6" style="text-align:center;">
			<a href="kidrestaurant.php"><img src="images/kidrest.png" style="border-radius:50%;width:60%;" alt=""/></a>
		</div>
