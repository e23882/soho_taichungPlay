  ...
  <a class="right carousel-control" href="#carousel-example-generic" role="button" data-slide="next">
	...
	<div class="row"  style="margin-top:5%;margin-bottom:15%;width:100%; position: absolute;left: 0;right: 0;margin-left: auto;margin-right: auto;">
		...
		<div class="col-xs-6 col-md-3" style="text-align:center;">
			<a href="restaurant.php"><img src="images/restaurant.png" style="border-radius:50%;width:60%;" alt=""/></a>
		</div>
		<div class="col-xs-6 col-md-3" style="text-align:center;">
			<a href="pet.php"><img src="images/pet.png" style="border-radius:50%;width:60%;" alt=""/></a>
		</div>
		<div class="col-xs-6 col-md-3" style="text-align:center;">
			<a href="member.php"><img src="images/member.png" style="border-radius:50%;width:60%;" alt=""/></a>
		</div>
		<div class="col-xs-6 col-md-3" style="text-align:center;">
			<a href="view.php"><img src="images/view.png" style="border-radius:50%;width:60%;" alt=""/></a>
		</div>
	</div>
